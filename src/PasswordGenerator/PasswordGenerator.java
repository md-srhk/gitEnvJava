...
public class PasswordGenerator {
	...
	public static void main(String[] args) {
		...
		boolean allOrJustCharacters = false;
	...
	public static void askUserForData(Scanner scanner) {
	...
	public static void main(String[] args) {
		...
		while(true) { // Infinite loop until the user decides to exit
			...
			do {
				...
				isUserInputANumber = true; // Assume the input is a number
			...
			System.out.printf("%n%n");
			generatedPassword = generatePassword(passwordLength); // Generate password with all characters
			System.out.printf("Generated password: %s%n" , generatedPassword);
			System.out.printf("%n");
			getPasswordStrength(generatedPassword); // Evaluate password strength
			
			System.out.printf("%n%n");
			generatedPassword = generatePassword(passwordLength, true); // Generate password with only letters
			System.out.printf("Generated password: %s%n" , generatedPassword);
			System.out.printf("%n");
			getPasswordStrength(generatedPassword);
