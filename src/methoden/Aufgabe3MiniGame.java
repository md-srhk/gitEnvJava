...
public static void main(String[] args) {
        ...
        while (playerWantsToPlay) {
            ...
            switch (gamemode) {
                ...
                case 1:
                    ...
                    runNumberGuessingGamemode(scanner, randomGen, attempts);
                    
                    break;
                    
                case 2:
                	
                	runWordGuessingGamemode(scanner, mixedWord, attempts, originalWord);
	...
	public static void runNumberGuessingGamemode(Scanner scanner, Random randomGen, int attempts) {
	...
	public static void runWordGuessingGamemode(Scanner scanner, StringBuilder mixedWord, int attempts, String originalWord) {
